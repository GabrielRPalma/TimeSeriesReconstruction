####################################################################################################
###
### File:    02_Bayesian_VAR.r
### Purpose: Fitting a Bayesian Gaussian VAR model
...
# The example from Andrew Parnell research group 
...
# The VAR model is a multivariate extension of the standard AR(p) model. In this code I just fit the VAR(1) model but
#it is easily extended to VAR(p)
